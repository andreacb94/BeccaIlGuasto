...
import finestre.pannelli.PannelloMenuVittoria;
...
public class Vittoria extends JFrame{
    ...
    //Metodo costruttore
    public Vittoria(Gioco gioco, JFrame master){
        
        //Creo la finestra
        creaFinestraSconfitta();
        
        //Creo il pannello del menù e lo aggiungo alla finestra
        PannelloMenuVittoria pannello = new PannelloMenuVittoria(gioco, master, this);
        add(pannello);
