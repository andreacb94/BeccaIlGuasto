...
public class PannelloMenuSconfitta extends JPanel {
    ...
    public PannelloMenuSconfitta(Gioco gioco, JFrame master, JFrame finestra){
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(new ImageIcon(Menu.class.getResource("/immagini/finestre/sconfitta.png")).getImage(), 0, 0, larghezza, altezza, this);
    }
